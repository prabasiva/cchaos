...
%wind(1,:)=gausswin(100);
%wind(2,:)=hamming(100);
%tit={'Gaussian Window of length 100','Hamming Window of length 100'}
    %figure;
  figure('PaperType','tabloid')
    subplot(5,3,1);
    plot(t,x);
...
subplot(5,3,10);
    ...
    title({'Gaussian Window of window length = 100'},...
...
subplot(5,3,13);
    ...
    title({'Hamming Window of window length = 100'},...
        'FontSize',16,'FontWeight','bold')
    ...
    subplot(5,3,11);
        spectrogram(sp,gausswin(win),[],[],4/(1e7),'yaxis');
    ...
    subplot(5,3,14);
        spectrogram(sp,hamming(win),[],[],4/(1e7),'yaxis');
    ...
    subplot(5,3,12);
        spectrogram(na,gausswin(win),[],[],4/(1e7),'yaxis')
    ...
    subplot(5,3,15);
        spectrogram(na,hamming(win),[],[],4/(1e7),'yaxis')
